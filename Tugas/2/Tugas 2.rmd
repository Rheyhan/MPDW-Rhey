...
data.trans<-data.frame(month = (data$Month[-1]-data$Month[-n]*optimumrho),
                       V2 = (data$V2[-1]-data$V2[-n]*optimumrho),
                       V3 =(data$V3[-1]-data$V3[-n]*optimumrho))

#Testing gasus marcov asumptions on transformed data
model.trans <- lm(V2~month+V3, data.trans)
